...
class Parser:
    ...
    def for_expr(self):
        ...
        if not self.current_tok.type == TT_IDENTIFIER:
            return res.failure(self.current_tok.pos_start, self.current_tok.pos_end, "Expected identifier")
        var_name = self.current_tok
        res.register_advancement()
        self.advance()
        if not self.current_tok.type == TT_EQ:
            return res.failure(self.current_tok.pos_start, self.current_tok.pos_end, "Expected '=='")
        res.register_advancement()
        self.advance()
    ...
    def atom(self):
        ...
        if tok.type in (TT_INT, TT_FLOAT):
            ...
            for_loop = res.register(self.while_expr())
            if res.error: return res
